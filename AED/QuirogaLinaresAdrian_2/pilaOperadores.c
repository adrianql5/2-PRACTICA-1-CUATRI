...
//MODIFICAR: PARA LA PILA DE OPERADOREVS: char
//MODIFICAR: PARA LA PILA DE OPERANDOS: abin
typedef char tipoelemPila;
///////////////////////////////////////////////////////
...
tipoelemPila topeOperadores(pilaOperadores P) {
    if (!esVaciaPilaOperadores(P)) /*si pila no vacia*/
        return P->elemento;
}

void pushOperadores(pilaOperadores *P, tipoelemPila E) {
    pilaOperadores aux;
